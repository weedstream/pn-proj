                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="" method="post">
                        <div class="form-group <?=form_error('name_loket') ? 'has-error' : null?>">
                            ...
                            <input type="text" name="name_loket" value="<?=isset($_POST['name_loket']) ? $_POST['name_loket'] : $row->name_loket?>" class="form-control">
                        ...
                        <div class="form-group <?=form_error('kode_loket') ? 'has-error' : null?>">
                            ...
                            <input type="hidden" name="loket_id" value="<?=$row->loket_id?>">
                            <input type="text" name="kode_loket" value="<?=isset($_POST['kode_loket']) ? $_POST['kode_loket'] : $row->kode_loket?>" class="form-control">
                            <span class="help-block"><?=form_error('kode_loket')?></span>
                        </div>
                        <div class="form-group <?=form_error('keterangan') ? 'has-error' : null?>">
                            <label>Keterangan *</label>
                            <input type="text" name="keterangan" value="<?=isset($_POST['keterangan']) ? $_POST['keterangan'] : $row->keterangan?>" class="form-control">
