        ...
        <div class="col-lg-12">
            <div class="box box-widget">
                <div class="box-body">
                                ...
                                <div class="form-group">
                                    <select name="member" class="form-control">
                                        ...
                                        <?php foreach ($loket as $l => $data) { ?>
                                            ...
                                            <option value="<?= $data->loket_id ?>"
                                                <?= $data->loket_id ? 'selected' : NULL ?>><?= $data->keterangan ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </td>
                    ...
                    <center>
                        <a href="<?php echo site_url('ambil/prosses/' . $antri); ?>"
                            class="btn btn-primary"><i class="glyphicon glyphicon-save"></i> &nbsp;Dapatkan Nomer
                            Antrian</a>
                    </center>
                </div>
            </div>
