  ...
  <div class="row">
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-aqua">
        <div class="inner">
          <h3><?php echo $this->fungsi->count_loket(); ?></h3>
        ...
        <a href="<?php echo site_url('loket'); ?>" class="small-box-footer">
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-green">
        <div class="inner">
          <h3><?php echo $this->fungsi->count_antrianloket(); ?></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-red">
        <div class="inner">
          <h3><?php echo $this->fungsi->count_antriantotal(); ?></h3>
