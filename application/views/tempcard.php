...
<head>
    ...
    <title>Pengadilan Negeri Purbalingga</title>
    ...
    <div class="wrapper">
                ...
                <div class="container">
                    <div class="navbar-header">
                        <a href="#" class="navbar-brand">
                            <b>Pengadilan Negeri Purbalingga</b>
                        </a>
        ...
        <footer class="main-footer">
            <div class="container">
                ...
                <strong>Copyright &copy; <?php echo date("Y")?> <a href="<?=site_url('dashboard')?>">Pengadilan Negeri Purbalingga</a>.</strong>
            </div>
            <!-- /.container -->
        </footer>
    </div>
